    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">Tabel Owner</h3>
                    <div class="col">
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <tbody>
                                <?php 
                                $no=0;
                                    $data = mysqli_query($koneksi,"select * from tb_akses where hak_akses ='owner'");
                                    while($d = mysqli_fetch_array($data)){
                                        $no++;
                                        ?>
                                <tr align="center">
                                    <td><?php echo "$no" ?></td>                         
                                    <td><?php echo $d['id_akses']; ?></td>                           
                    ...
                    <!-- Lokasi Simpan -->
                    <h3 class="fs-4 mb-3">Tabel Karyawan</h3>
                    <div class="col">
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            <thead>
                                <tr align="center">
                            ...
                            <tbody>
                                <?php 
                                $no=0;
                                    $data = mysqli_query($koneksi,"select * from tb_akses where hak_akses ='karyawan'");
                                    while($d = mysqli_fetch_array($data)){
                                        $no++;
                                        ?>
                                <tr align="center">
                                    ...
                                    <td><?php echo $d['nama']; ?></td>                            
                                    <td><div id="thanks">
                                        <a onclick="return confirm ('Yakin hapus Akun dari <?php echo $d['nama'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Produk" href="hapus/hapus_karyawan.php?hal=hapus&kd=<?php echo $d['id_akses'];?>"><span class="fa fa-lg fa-trash"> </span></a>
                                    </td>                           
                                </tr>
                                <?php
                                    }
