                        ...
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <tbody>
                                <?php 
                                    $no=0;
                                    if($cari != ''){
                                        $data = mysqli_query($koneksi,"select * from tb_produk where nama_produk like '%".$cari."%' or
                                ...
                                <tr align="center">
                                    <td><?php echo "$no" ?></td>                           
                                    <td><img src="../../salon/gambar/<?php echo $d['gambar'] ?>"  width="80px" height="80px" /></td>                           
                                    <td><?php echo $d['nama_produk']; ?></td>                           
                                    <td><?php echo $d['kategori']; ?></td>                           
                                    <td><?php echo $d['lokasi']; ?></td>                           
                                    <td><?php echo $d['jumlah']; ?></td>                           
                                    <td><div id="thanks">
                                        <a onclick="return confirm ('Yakin Tambah Jumlah barang <?php echo $d['nama_produk'];?>.?');" class="btn btn-sm btn-success tooltips" data-placement="bottom" data-toggle="tooltip" title="Barang Masuk" href="edit/tambah_stok.php?hal=hapus&kd=<?php echo $d['id_produk'];?>"><span class="fas fa-plus-circle"> </span></a>
                                        <a onclick="return confirm ('Yakin Kurangi Jumlah Barang <?php echo $d['nama_produk'];?>.?');" class="btn btn-sm btn-warning tooltips" data-placement="bottom" data-toggle="tooltip" title="Barang Keluar" href="edit/kurang_stok.php?hal=edit&kd=<?php echo $d['id_produk'];?>"><span class="fas fa-minus-circle"> </span></a>
                                    </td>                           
                                    <td><div id="thanks">
                                        <a onclick="return confirm ('Yakin hapus <?php echo $d['nama_produk'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Produk" href="hapus/hapus_produk.php?hal=hapus&kd=<?php echo $d['id_produk'];?>"><span class="fa fa-lg fa-trash"> </span></a>
